...
for i in range(0, len(rest)):
        ...
        if (int(prev_array[0]) - int(cur_array[0])) >= dup_window:
                fwrite.write(cur)
        else:
        # If any of the other columns are not same, they are not dupes
                if not(prev_array[1]==cur_array[1] and prev_array[2]==cur_array[2] and prev_array[3]==cur_array[3] and prev_array[4]==cur_array[4] and prev_array[5]==cur_array[5] and prev_array[6]==cur_array[6] and prev_array[7]==cur_array[7] and prev_array[8]==cur_array[8] and prev_array[9]==cur_array[9] and prev_array[10]==cur_array[10] and prev_array[11]==cur_array[11] and prev_array[12]==cur_array[12] and prev_array[13]==cur_array[13] and prev_array[14]==cur_array[14] and prev_array[15]==cur_array[15] and prev_array[16]==cur_array[16] and prev_array[17]==cur_array[17] and prev_array[18]==cur_array[18] and prev_array[19]==cur_array[19] and prev_array[20]==cur_array[20] and prev_array[21]==cur_array[21]):
                        fwrite.write(cur)
        prev=cur
